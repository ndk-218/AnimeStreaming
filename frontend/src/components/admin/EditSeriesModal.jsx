  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary-400 to-indigo-600 text-white p-6 rounded-t-xl">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold">Edit Series</h2>
              <p className="text-primary-100 text-sm mt-1">Update series information</p>
            </div>
            <button
              onClick={onClose}
